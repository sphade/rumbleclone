...
<div class="relative w-full shadow-lg h-[350px] md:h-[545px]" bind:this={videoContainer}>
  <video
  ...
  >
    <button type="button" class="h-5 w-5" on:click={playPause}>
      {#if paused}
    ...
    >
      ...
      >
        <div
          ...
          class="bg-[#85c742] transition h-full rounded-lg"
        />
      </div>
    </button>
